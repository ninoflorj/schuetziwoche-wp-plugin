...
function schuetziwoche_admin_registrations(){
    ...
    <div class="wrap">
        ...
        <form id="movies-filter" method="get">
            ...
            <input type="hidden" name="page" value="<?php echo $_REQUEST['page'] ?>" form="movies-filter" />
        </form>
...
function schuetziwoche_admin_add_page(){
    add_menu_page('Schütziwoche - Übersicht', 'Schütziwoche', 'edit_posts', SCHUETZIWOCHE_MENU_SLUG, 'schuetziwoche_admin_overview', plugins_url() . '/schuetziwoche/img/plugin-logo.png', 2 );
    add_submenu_page( SCHUETZIWOCHE_MENU_SLUG, 'Schütziwoche - Tabelle', 'Anmeldetabelle', 'edit_posts', SCHUETZIWOCHE_MENU_SLUG .'-table', 'schuetziwoche_admin_registrations');
